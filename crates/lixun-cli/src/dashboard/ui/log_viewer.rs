...
pub fn render_log_viewer(frame: &mut Frame, area: Rect, app: &App) {
    ...
    let mut title_spans = vec![
        ...
        Span::styled(
            "I",
            Style::default()
                .fg(if app.log_filter_info {
                    Color::White
                } else {
                    Color::DarkGray
                })
                .add_modifier(if app.log_filter_info {
                    Modifier::BOLD
                } else {
                    Modifier::empty()
                }),
        ...
        Span::styled(
            "W",
            Style::default()
                .fg(if app.log_filter_warn {
                    Color::Yellow
                } else {
                    Color::DarkGray
                })
                .add_modifier(if app.log_filter_warn {
                    Modifier::BOLD
                } else {
                    Modifier::empty()
                }),
        ...
        Span::styled(
            "E",
            Style::default()
                .fg(if app.log_filter_error {
                    Color::Red
                } else {
                    Color::DarkGray
                })
                .add_modifier(if app.log_filter_error {
                    Modifier::BOLD
                } else {
                    Modifier::empty()
                }),
        ...
        Span::styled(
            "D",
            Style::default()
                .fg(if app.log_filter_debug {
                    Color::White
                } else {
                    Color::DarkGray
                })
                .add_modifier(if app.log_filter_debug {
                    Modifier::BOLD
                } else {
                    Modifier::empty()
                }),
